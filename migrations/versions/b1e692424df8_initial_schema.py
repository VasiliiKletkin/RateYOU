...
def upgrade() -> None:
    ...
    sa.Column('language', sa.Enum('EN', 'RU', 'ES', 'PT', 'DE', 'FR', 'IT', 'TR', 'UK', 'PL', 'AR', 'FA', 'ID', 'VI', 'ZH', 'HI', 'BN', 'AM', 'UZ', 'KO', 'JA', 'TH', name='language'), nullable=False),
    ...
    sa.Column('provider', sa.Enum('TELEGRAM_STARS', name='provider'), nullable=False),
    sa.Column('purpose', sa.String(length=64), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'PAID', 'FAILED', 'REFUNDED', name='status'), nullable=False),
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('owner_id', sa.Uuid(), nullable=False),
    sa.Column('tier', sa.Enum('BRONZE', 'SILVER', 'GOLD', 'BONUS', name='tier'), nullable=False),
    sa.Column('source', sa.Enum('PURCHASE', 'BONUS', name='subscriptionsource'), nullable=False),
    ...
    op.create_index('ix_subscriptions_owner_expires', 'subscriptions', ['owner_id', 'expires_at'], unique=False)
    op.create_index('ix_subscriptions_transaction', 'subscriptions', ['transaction_id'], unique=True, postgresql_where='transaction_id IS NOT NULL')
...
def downgrade() -> None:
    ...
    op.drop_index('ix_subscriptions_transaction', table_name='subscriptions', postgresql_where='transaction_id IS NOT NULL')
    op.drop_index('ix_subscriptions_owner_expires', table_name='subscriptions')
