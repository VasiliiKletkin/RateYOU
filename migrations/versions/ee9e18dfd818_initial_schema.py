...
Revision ID: ee9e18dfd818
Revises:
Create Date: 2026-05-13 00:03:08.201966
...
def upgrade() -> None:
    ...
    # Geography column is added — skipping explicit op.create_index here.
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "PAID", "FAILED", "REFUNDED", name="status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_profile_photos_profile_id"), "profile_photos", ["profile_id"], unique=False
    )
    op.create_table(
        "subscriptions",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("owner_id", sa.Uuid(), nullable=False),
        sa.Column(
            "tier", sa.Enum("BRONZE", "SILVER", "GOLD", "BONUS", name="tier"), nullable=False
        ),
        sa.Column(
            "source", sa.Enum("PURCHASE", "BONUS", name="subscriptionsource"), nullable=False
        ),
    ...
    op.create_index(
        "ix_subscriptions_owner_expires", "subscriptions", ["owner_id", "expires_at"], unique=False
    )
    op.create_index(
